<?php
	...
	if (!isset($_GET['id']) || !isset($_GET['username'])){
		$msg = "<div class='alert alert-danger' role='alert'>Oops! Page not found</div>";   //assign an error message
	}
	else{
		$id = $_GET['id'];
		...
		$sql="SELECT  * FROM dealeraccount where `id`='$id' and username = '$username'";
    ...
    function dealerSaleChart() {
		var data = google.visualization.arrayToDataTable([
			...
			<?php		
						...
						$sql2="SELECT  id FROM customerdata where `dealerid`='$id'";
...
<body>
	...
	<?php
		if(!empty($msg)){
			...
			<?php
				$sql="SELECT  username FROM dealeraccount where `id`='$id'";
			...
			<p class="display-4 text-center"><b><?php echo $row['username']; ?></b></p>
