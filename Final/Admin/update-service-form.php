...
if (isset($_GET['id'])) {
	...
	$qq="SELECT * FROM serviceform where id='".$id."'";
	...
	if($_POST)
	{
		...
		$s1 = "UPDATE serviceform SET question='".$question."',option1='".$option1."',option2='".$option2."',option3='".$option3."',
	...
	<div class="container class-content">
		...
		<form method="POST" action="#" enctype="multipart/form-data">
				...
				<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" placeholder="Enter 1st Question" name="question" value = "<?php echo $q1 ?>"required>
						</div>
				</div>
