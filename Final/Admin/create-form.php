<?php
	...
	if(isset($_POST['submit']))
	{
		...
		if($type=="sale")
		{
			$p="INSERT INTO saleform (question,option1,option2, option3, option4)values
			('".$question."','".$choice1."','".$choice2."','".$choice3."','".$choice4."')";
		
			if(mysqli_query($conn,$p))
			{
				$msg = "<div class='alert alert-success' role='alert'>Sucessfully Added New Question In Sale Form</div>";
			}
			else
			{
...
<?php 
	...
	<form method="POST" action="#" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="form-check form-check-inline">
						<label class="form-check-label">
							<input class="form-check-input" type="radio" name="formtype" value="sale" required>
							Sale
						</label>
					</div>
					...
					<div class="form-check form-check-inline">
						<label class="form-check-label">
							<input class="form-check-input" type="radio" name="formtype" value="service">
							Service
						</label>
					</div>
				...
				<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" name="question" class="form-control" placeholder="Enter 1st Question" name="q1" required>
						</div>
				</div>
