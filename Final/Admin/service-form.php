...
<body>
	...
	<div class="container class-content">
		...
		<p class="display-4 text-center"><b>Service Form</b></p>
		...
		$qq="SELECT * FROM serviceform order by id";
				...
				<div class="card" style="width: 30rem;">
					...
					<ul class="list-group list-group-flush">
						...
						<li class="list-group-item"><?php 
											echo '<a href="update-service-form.php?id='.$row["id"].'"><button class="btn btn-outline-primary">Update</button></a>'; 
											//echo '<a href="delete-service-question.php?id='.$row["id"].'"><button class="btn btn-outline-danger"style="margin-left:10px;">Delete</button></a>'; 
											?></td>
										</tr></li>
						</ul>
				</div>
		...
		<a href="add-service-question.php" ><button class="btn btn-outline-primary" style="width:200px;margin-left:450px;">Add Question</button></a>-->
	</div>
	<?php 
	}
	else
