...
<?php 
	...
	<div class="container class-content">
		...
		<div>
		<?php 
				echo '<a href="update-account.php?id='.$row["id"].'"><button class="btn btn-outline-primary" style="margin-left:473px;">Update</button></a>'; 
				echo '<a href="delete-account.php?id='.$row["id"].'"><button class="btn btn-outline-danger" style="margin-left:10px;">Delete</button></a>'; 
				?>
		</div>
